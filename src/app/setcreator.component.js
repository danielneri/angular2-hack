...
var SetCreatorComponent = (function () {
    function SetCreatorComponent(_characterService) {
        this._characterService = _characterService;
    }
    Object.defineProperty(SetCreatorComponent.prototype, "characters", {
        get: function () {
    ...
    SetCreatorComponent.prototype.onSelect = function (character) { this.currentCharacter = character; };
    /////////////////
    SetCreatorComponent.prototype.getCharacters = function () {
        var _this = this;
        this._characters = [];
    ...
    SetCreatorComponent = __decorate([
    ...
    return SetCreatorComponent;
})();
exports.SetCreatorComponent = SetCreatorComponent;
//# sourceMappingURL=setcreator.component.js.map